...
;;; Rust 1.93.0 from guix-rustup channel
;;; Include riscv32imac-unknown-none-elf target for bare-metal code (boot0, boot1, etc.)
(define rust-1.93.0 (rustup "1.93.0" #:targets '(riscv32imac-unknown-none-elf)))
